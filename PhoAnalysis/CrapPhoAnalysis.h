...
// $Id: CrapPhoAnalysis.h,v 1.8 2013/05/05 12:01:32 yiiyama Exp $
//

#ifndef CrapPhoAnalysis_h
#define CrapPhoAnalysis_h
...
class CrapPhoAnalysis {
public:
  CrapPhoAnalysis(TTree&);
  virtual ~CrapPhoAnalysis();
...
CrapPhoAnalysis::CrapPhoAnalysis(TTree& tree) :
  event(),
  fTree(&tree),
  outputName("analysis"),
...
CrapPhoAnalysis::~CrapPhoAnalysis()
{
}

void
CrapPhoAnalysis::IncludeAJson(TString const& _fileName)
{
  if(_fileName == "") return;
...
bool
CrapPhoAnalysis::IsGoodLumi(UInt_t run, UInt_t lumi) const
{
...
bool
CrapPhoAnalysis::PassTriggers() const
{
