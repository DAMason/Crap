...
// $Id: Crap.h,v 1.8 2013/05/05 12:01:32 yiiyama Exp $
//
...
void
Crap::IncludeAJson(TString const& _fileName)
{
  if(_fileName == "") return;
...
bool
Crap::IsGoodLumi(UInt_t run, UInt_t lumi) const
{
